...
Hi! My name is **ARINDAM RAINA**, I have created this project to learn MERN Stack web-development with assistance of 6pack programmer youtube channel.

# Prerequisite

1.  Must have basic knowledge of **Node**, **React**, **Express**, **MongoDB** . _Refer to the following tutorials to understand the technologies used in this project_. **Links are Below respectively**
...
checkout abhishek singh who was my mentor in this project.
